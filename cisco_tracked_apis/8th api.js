...
var options = {
  "method": "POST",
  "hostname": "wdm-a.wbx2.com",
  "port": null,
  "path": "/wdm/api/v1/devices",
  "headers": {
    ...
    "trackingid": "web-client_06f44fda-3d86-4c60-9955-06ea4135a9de_5",
    "user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36",
    "cache-control": "no-cache",
    "postman-token": "7d4a8fc2-b4b2-5128-16f7-7691432c4bc6"
  }
};
...
req.write(JSON.stringify({ name: 'browser',
  deviceType: 'WEB',
  model: 'DESKTOP',
  localizedModel: 'DESKTOP',
  systemName: 'DESKTOP',
  systemVersion: '2.1367.0',
